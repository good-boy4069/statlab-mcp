...
> tools and interprets output — **no LLM participates in any of the 27 first-layer tools' computations.**
>
...
27 real statistical tools instead: descriptive statistics, correlation, hypothesis tests, power analysis,
...
| **AI agent developers** | Plug it in as the statistics backend of your agent/workflow | 27 deterministic tools + one uniform protocol; easy to integrate and test |
...
2. **Anti-hallucination design**: zero LLM in the 27 first-layer tools; conclusion sentences are assembled
...
3. **Pinned, recomputable conventions**: q1/q3 = linear interpolation (same convention as Excel
   ...
   (**314 pytest tests**; CI re-checks that number automatically — drift turns the build red)
...
| Statistical inference | hypothesis_test, anova_test, chi_square_test, normality_test, confidence_interval, effect_size, nonparametric_test, power_analysis |
...
- Quality bar: full pytest green (**currently 314 tests**), tool-module coverage ≥80% (~90% locally
