...
3. **Pinned, recomputable conventions**: q1/q3 = linear interpolation (same convention as Excel
   ...
   (**383 pytest tests**; CI re-checks that number automatically — drift turns the build red)
...
- Quality bar: full pytest green (**currently 383 tests**), tool-module coverage ≥80% (~90% locally
